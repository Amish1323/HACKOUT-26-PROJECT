...
if use_ai_api:
    ...
    api_key = st.sidebar.text_input(
        ...
        type="password",
        key="sb_api_key_v45",
        help="Loaded automatically from .streamlit/secrets.toml or environment variables if available. Or paste key directly."
    )
    ...
    if api_key:
        ...
        st.sidebar.info("💡 Key not found in secrets/env. Paste your Google AI Studio key above or run in Offline Mode.")
